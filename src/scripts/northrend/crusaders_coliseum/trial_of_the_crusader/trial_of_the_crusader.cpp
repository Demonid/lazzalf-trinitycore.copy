...
#define GOSSIP_START_EVENT   "Ich bin bereit!"
#define GOSSIP_START_EVENT1  "Weiter gehts, lasst den D\x84 mon nur kommen!"
#define GOSSIP_START_EVENT2  "Pff... Diese Champions sind kein Gegner für uns!"
#define GOSSIP_START_EVENT3  "Die Diener des Lichk\x94 nigs? Die machen wir platt!"
#define GOSSIP_START_EVENT4  "Wir danken für die Herrausforderung. Aber wir würden gerne weitermachen!"
...
const Position SpawnPositionTirion = {563.47, 78.24, 418.20, 1.50};
const Position SpawnPositionGarrosh = {502.94, 142.37, 418.21, 0.04};
const Position SpawnPositionVarian = {624.95, 139.41, 418.20, 3.15};
  ...
  void UpdateAI(const uint32 uiDiff)
	...
	if (uiTimer <= uiDiff)
	{
	  ...
	  case 1:
		...
		if (Creature* pTemp=me->SummonCreature(NPC_LORD,SpawnPositionTirion,TEMPSUMMON_TIMED_DESPAWN,40000))
		{
		me->AddThreat(pTemp, 0.0f);
	  ...
	  case 6:
		if (pInstance)
		pInstance->SetData64(DATA_MAIN_DOOR,2);
		if (Creature* pTemp=me->SummonCreature(NPC_LORD,SpawnPositionTirion,TEMPSUMMON_TIMED_DESPAWN,10000))
		{
		me->AddThreat(pTemp, 0.0f);
		uiLord = pTemp->GetGUID();
		pTemp->SetFlag(UNIT_FIELD_FLAGS,UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_OOC_NOT_ATTACKABLE);
	  ...
	  case 9:
		if (pInstance)
		pInstance->SetData64(DATA_MAIN_DOOR,2);	
		if (Creature* pTemp=me->SummonCreature(NPC_VARIAN,SpawnPositionVarian,TEMPSUMMON_TIMED_DESPAWN,17000))
		{
		me->AddThreat(pTemp, 0.0f);
		...
		if (Creature* pTemp=me->SummonCreature(NPC_LORD,SpawnPositionTirion,TEMPSUMMON_TIMED_DESPAWN,17000))
		{
		me->AddThreat(pTemp, 0.0f);
		uiLord = pTemp->GetGUID();
		pTemp->SetFlag(UNIT_FIELD_FLAGS,UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_OOC_NOT_ATTACKABLE);
	  ...
	  case 14:
		if (pInstance)
		pInstance->SetData64(DATA_MAIN_DOOR,2);
		if (Creature* pTemp=me->SummonCreature(NPC_LORD,SpawnPositionTirion,TEMPSUMMON_TIMED_DESPAWN,4000))
		{
		me->AddThreat(pTemp, 0.0f);
		uiLord = pTemp->GetGUID();
		pTemp->SetFlag(UNIT_FIELD_FLAGS,UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_OOC_NOT_ATTACKABLE);
	...
	if (uiTimer2 <= uiDiff)
	{
	   ...
	   case 1:
		...
		break;
	   case 2:
		if (Creature* pTemp=me->SummonCreature(NPC_LORD,SpawnPositionTirion,TEMPSUMMON_TIMED_DESPAWN,54500))
		{
		me->AddThreat(pTemp, 0.0f);
		uiLord = pTemp->GetGUID();
		pTemp->SetFlag(UNIT_FIELD_FLAGS,UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_OOC_NOT_ATTACKABLE);
	   ...
	   case 3:
		...
		if (Creature* pTemp = Unit::GetCreature(*me, uiLord))
		 pTemp->SetUInt32Value(UNIT_NPC_EMOTESTATE, EMOTE_ONESHOT_NONE);
		if (Creature* pTemp=me->SummonCreature(NPC_NEPOPALIS,SpawnPosition1,TEMPSUMMON_TIMED_DESPAWN,45500))
		{
		me->AddThreat(pTemp, 0.0f);
	   ...
	   case 4: //Start retual
		...
		{
		pTemp->GetMotionMaster()->MovePoint(1, 553.471436, 140.024200, 393.918213);
	   ...
	   case 6:
		if (Creature* pTemp = Unit::GetCreature(*me, uiNepopalis))
		 pTemp->CastSpell(pTemp,33271,false);
		if (Creature* pBoss=me->SummonCreature(BOSS_LORD_JARAXXUS,574.08, 140.35, 393.91,3.14,TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 600000))
		{
		me->AddThreat(pBoss, 0.0f);
	   ...
	   case 13:
		...
		break;
	   case 14:
		if (Creature* pTemp=me->SummonCreature(NPC_LORD,SpawnPositionTirion,TEMPSUMMON_TIMED_DESPAWN,86000))
		{
		me->AddThreat(pTemp, 0.0f);
		uiLord = pTemp->GetGUID();
		pTemp->SetFlag(UNIT_FIELD_FLAGS,UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_OOC_NOT_ATTACKABLE);
	   ...
	   case 15:
		if (Creature* pTemp = Unit::GetCreature(*me, uiLord))
		 pTemp->SetUInt32Value(UNIT_NPC_EMOTESTATE, EMOTE_ONESHOT_NONE);
		if (Creature* pTemp=me->SummonCreature(NPC_KRIK,SpawnPositionGarrosh,TEMPSUMMON_TIMED_DESPAWN,70000))
		{
		me->AddThreat(pTemp, 0.0f);
	   ...
	   case 16:
		if (Creature* pTemp = Unit::GetCreature(*me, uiKrik))
		 pTemp->SetUInt32Value(UNIT_NPC_EMOTESTATE, EMOTE_ONESHOT_NONE);
		if (Creature* pTemp=me->SummonCreature(NPC_VARIAN,SpawnPositionVarian,TEMPSUMMON_TIMED_DESPAWN,57000))
		{
		me->AddThreat(pTemp, 0.0f);
		uiVarian = pTemp->GetGUID();
		pTemp->SetFlag(UNIT_FIELD_FLAGS,UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_OOC_NOT_ATTACKABLE);
	   ...
	   case 24:
		...
		pInstance->SetData64(DATA_MAIN_DOOR,1);
		me->SetVisibility(VISIBILITY_OFF);
		if (Creature* pTemp=me->SummonCreature(NPC_LORD,SpawnPositionTirion,TEMPSUMMON_TIMED_DESPAWN,38000))
		{
		me->AddThreat(pTemp, 0.0f);
		uiLord = pTemp->GetGUID();
		pTemp->SetFlag(UNIT_FIELD_FLAGS,UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_OOC_NOT_ATTACKABLE);
	   ...
	   case 28:
		...
		NextStep2(2000,true);
	   case 29:
		if (Creature* pTemp=me->SummonCreature(NPC_LORD,SpawnPositionTirion,TEMPSUMMON_TIMED_DESPAWN,60000))
		{
		me->AddThreat(pTemp, 0.0f);
		uiLord = pTemp->GetGUID();
		pTemp->SetFlag(UNIT_FIELD_FLAGS,UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_OOC_NOT_ATTACKABLE);
