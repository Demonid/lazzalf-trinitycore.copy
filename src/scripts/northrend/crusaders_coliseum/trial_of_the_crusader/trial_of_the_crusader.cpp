...
{
    {"Are you ready to start the trial?",GOSSIP_ACTION_INFO_DEF+1,false,TYPE_BEASTS},
    {"Are you ready to the next round?",GOSSIP_ACTION_INFO_DEF+2,false,TYPE_JARAXXUS},
    {"Are you ready to fight with the Champions?",GOSSIP_ACTION_INFO_DEF+3,false,TYPE_CRUSADERS},
    {"Are you ready to the next round?",GOSSIP_ACTION_INFO_DEF+4,false,TYPE_VALKIRIES},
    {"Are you ready to carry on fighting with Anub'arak?",GOSSIP_ACTION_INFO_DEF+5,false,TYPE_ANUBARAK},
    {"For today the arena was closed.",GOSSIP_ACTION_INFO_DEF+6,true,TYPE_ANUBARAK},
};
...
//Summoning crusaders
        case 3091:
               ...
               if (pInstance->GetData(TYPE_DIFFICULTY) == RAID_DIFFICULTY_25MAN_NORMAL 
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_1_7))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                                           }
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_1_8))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                                           }
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_1_9))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                                           }
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_1_10))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                                           }
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_0_1))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_0_2))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                                           pTemp->SetRespawnDelay(DAY);
                                           }
...
//summoning crusaders
        case 3090:
               ...
               if (pInstance->GetData(TYPE_DIFFICULTY) == RAID_DIFFICULTY_25MAN_NORMAL 
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_2_7))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                                           }
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_2_8))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                                           }
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_2_9))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                                           }
                              ...
                              if (Creature* pTemp = (Creature*)Unit::GetUnit((*me),pInstance->GetData64(NPC_CRUSADER_2_10))) {
                                           pTemp->GetMotionMaster()->MovePoint(0, SpawnLoc[1].x, SpawnLoc[1].y, SpawnLoc[1].z);
                                           pTemp->AddUnitMovementFlag(MOVEMENTFLAG_WALK_MODE);
                                           }
                              me->SummonCreature(NPC_CRUSADER_0_1, SpawnLoc[13].x, SpawnLoc[13].y, SpawnLoc[13].z, 5, TEMPSUMMON_CORPSE_TIMED_DESPAWN, DESPAWN_TIME);
