            ...
            case SPELLFAMILY_WARLOCK:
            {
                ...
                else if (m_spellInfo->TargetAuraState == AURA_STATE_CONFLAGRATE)
                {
                    ...
                    if (aura)
                    {
                        ...
                        if (aura->GetSpellProto()->SpellFamilyFlags[0] & 0x4) //Immolate
                            damage += pdamage * 5 * pct_dir / 100; //HackFix per Immolate con Molten Core
                        else
                        ...
                        if (aura->GetSpellProto()->SpellFamilyFlags[0] & 0x4) //Immolate
                            m_currentBasePoints[1] = pdamage * 5 * pct_dot / 100; //HackFix per Immolate con Molten Core
                        else
