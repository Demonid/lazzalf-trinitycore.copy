...
{
{1883.89, 125.43, 342.378, 0},
{1845.32, 122.84, 342.378, 0},
{1788.78, 121.50, 342.378, 0},
{1814.68, 125.11, 342.378, 0},
{1843.22, 155.22, 342.378, 0},
...
CreatureAI* GetAI_mob_saronite_vapors(Creature *pCreature)
{
...
void AddSC_boss_general_vezax()
{
    ...
    newscript->GetAI = &GetAI_boss_general_vezax;
    newscript->RegisterSelf();
    
    newscript = new Script;
    newscript->Name = "mob_saronite_vapors";
    newscript->GetAI = &GetAI_mob_saronite_vapors;
    newscript->RegisterSelf();
